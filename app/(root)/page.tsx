function Page() {
  return (
    <div className="grid h-[120vh] grid-cols-12 grid-rows-14 gap-4 max-lg:flex max-lg:flex-col max-lg:gap-4">
      ...
      <div className="bg-card col-span-4 col-start-5 row-span-4 rounded-md">
        2
      </div>
